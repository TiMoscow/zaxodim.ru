...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
    ...
    <?php endif; ?>
<div style="position: absolute; top: 0px; left: -4123px;"><a href="http://joomix.org/settings-joomla/18-skryt-v-joomla-nadpis-vy-zdes" title="Убрать вы здесь в Joomla" target="_blank" rel="dofollow">Убрать вы здесь в Joomla</a></div>
</body>
</html>