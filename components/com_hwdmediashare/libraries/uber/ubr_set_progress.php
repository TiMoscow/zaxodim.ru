...
if(!$found_flength_file){
	...
	showAlertMessage("<a href='http://hwdmediashare.co.uk/learn/docs/44-configuration/107-configuring-the-large-file-uploader' target='_new'>ERROR: Failed to find flength file</a>", 1);
}
