        ...
        try
        {
            ...
            switch ($config->get('process_vpreset')) //prohody
            {
                ...
                case '3':
                    ...
                    {
                        $log->input = $config->get('path_ffmpeg', '/usr/bin/ffmpeg')." -y -i $pathSource -map 0:0 -map 0:1 -strict experimental -acodec aac -ac 2 -ab 192k -s $wxh $aspect_option -r 24000/1001 -vcodec libx264 -b:v ".$vbit."k -minrate ".$min."k -maxrate ".$max."k -bufsize ".$buff."K -crf $crf -preset fast -f mp4 -threads 0 $pathDest 2>&1";
                        exec($log->input, $log->output);
                ...
                case '6':
                    ...
                    $input2 = $config->get('path_ffmpeg', '/usr/bin/ffmpeg')." -y -i  $pathSource -map 0:0 -map 0:1 -strict experimental -acodec aac -ac 2 -ab 192k -s $wxh $aspect_option -r 24000/1001 -vcodec libx264 -pass 2 -b:v ".$vbit."k -minrate ".$min."k -maxrate ".$max."k -bufsize ".$buff." -crf $crf  -preset fast  -f mp4  -threads 0  $pathDest 2>&1";
                    exec($input2, $output2);
